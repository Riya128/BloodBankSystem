...
class HospitalRegisterForm extends Component {
  constructor(props) {
    super(props);
    this.url = "http://localhost:8999/hospital-service/hospital/register";
    this.state = {
      name: "",
      email: "",
      password: "",
  ...
  render() {
    return (
      <div>
        {this.state.isRegistered ? <Navigate to="/hospitalLogin" /> : <h3></h3>}
        <Home />
        <br></br>
        <div
        ...
        >
          <form className="rounded p-4 p-sm-3" onSubmit={this.handleSubmit}>
            <h3 style={{ color: "purple" }}>Create your Hospital Account </h3>
            <h3>Sign Up</h3>
            ...
            <p>
              Already have an account? <a href="/hospitalLogin">Click</a> here
              to login.
            </p>
          </form>
        </div>
