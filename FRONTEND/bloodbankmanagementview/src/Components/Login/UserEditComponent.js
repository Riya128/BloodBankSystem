...
function UserEditComponent() {
  ...
  const base_url = "http://localhost:8999/user-service/user";
  let URL = `${base_url}/${id}`;
  ...
  return (
    <div>
      ...
      <header>
        <nav className="navbar navbar-expand-md navbar-dark bg-dark">
          ...
          <div className="button" style={{ marginLeft: "50px" }}>
            <a href="/userDashboard" className="navbar-brand">
              User Dashboard
            </a>
          </div>
      ...
      <h2 style={{ textAlign: "center" }}>Update User Details</h2>
      <div style={{ marginRight: "30%", marginBottom: "40%" }}>
        <form onSubmit={(e) => FormHandle(e)} style={{ width: "40%" }}>
          ...
          <div>
            ...
            {/* <button type="reset" class="btn btn-outline-primary text-center mr-2">Clear </button> */}
          </div>
        </form>
      </div>
    </div>
