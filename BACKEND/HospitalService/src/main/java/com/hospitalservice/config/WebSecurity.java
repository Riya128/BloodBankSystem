...
public class WebSecurity extends WebSecurityConfigurerAdapter {
	...
	@Autowired
	public WebSecurity(Environment environment, HospitalService userService, BCryptPasswordEncoder bCryptPasswordEncoder) {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.csrf().disable();
		http.authorizeRequests().antMatchers("/hospital/register").permitAll().anyRequest().authenticated().and()
	...
	private AuthenticationFilter getAuthenticationFilter() throws Exception {
		...
		authenticationFilter.setFilterProcessesUrl("/hospital/login");
